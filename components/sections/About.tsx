...
const About = () => {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      // Usamos .from() em vez de classes CSS para garantir que o conteúdo exista.
  ...
  return (
    <div ref={containerRef} className="container mx-auto px-6 h-full flex items-center justify-center relative">
      <div className="w-full max-w-6xl grid md:grid-cols-12 gap-12 lg:gap-20 items-center">
        ...
        {/* Image Section - Removed explicit opacity-0 class */}
        <div className="md:col-span-5 relative about-content">
        ...
        {/* Text Section - Removed explicit opacity-0 class */}
        <div className="md:col-span-7 space-y-8 about-content">
